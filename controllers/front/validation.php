...
class paylandsvalidationModuleFrontController extends ModuleFrontController
{
    public function postProcess()
    {
        ...
        Tools::redirect(Context::getContext()->link->getModuleLink('paylands', 'checkout', array(), true));
