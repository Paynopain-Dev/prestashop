...
class PaylandsConector
{
	...
	public function getPaymentData($source_id, $order)
	{
		...
		$data = array(
			...
			'url_ok' => 'prestashop/modules/' . basename(dirname(__FILE__)) . '/controllers/success.php',
			'url_ko' => 'prestashop/modules/' . basename(dirname(__FILE__)) . '/controllers/error.php',
			...
			"url_post" => 'prestashop/modules/' . basename(dirname(__FILE__)) . '/controllers/update.php',
