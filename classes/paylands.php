...
class PaylandsConector
{
	...
	public function getPaymentData($source_id, $order)
	{
		...
		$data = array(
			...
			'url_ok' => Context::getContext()->link->getModuleLink(basename(dirname(__FILE__)), 'success'),
			'url_ko' => Context::getContext()->link->getModuleLink(basename(dirname(__FILE__)), 'error'),
			...
			"url_post" => Context::getContext()->link->getModuleLink(basename(dirname(__FILE__)), 'update'),
