...
class PaylandsConector
{
	...
	public function getPaymentData($source_id, $order)
	{
		...
		$data = array(
			...
			'url_ok' => Context::getContext()->link->getModuleLink('paylands', 'success'),
			'url_ko' => Context::getContext()->link->getModuleLink('paylands', 'error'),
			...
			"url_post" => Context::getContext()->link->getModuleLink('paylands', 'update'),
